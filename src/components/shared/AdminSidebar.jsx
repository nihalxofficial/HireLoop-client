// components/shared/AdminSidebar.js
"use client";
...
export default function AdminSidebar({ isOpen, onClose }) {
  ...
  const mainNavItems = [
    ...
    { id: "users", icon: <Users size={18} />, label: "Users", badge: "1.2k", href: "/dashboard/admin/users" },
    { id: "companies", icon: <Building2 size={18} />, label: "Companies", badge: "156", href: "/dashboard/admin/companies" },
    { id: "jobs", icon: <BriefcaseBusiness size={18} />, label: "Jobs", badge: "342", href: "/dashboard/admin/jobs" },
  ];
