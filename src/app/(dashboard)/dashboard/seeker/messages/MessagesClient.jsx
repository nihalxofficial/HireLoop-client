// app/dashboard/seeker/messages/MessagesClient.js
"use client";
...
export default function MessagesClient({ 
  ...
  const handleSendMessage = () => {
    ...
    const message = {
      ...
      senderAvatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(userName || 'You')}&background=8B5CF6&color=fff&size=64`,
    ...
    setTimeout(() => {
      const reply = {
        id: `msg_${Date.now() + 1}`,
        senderId: selectedConversation.recruiterId,
        senderName: 'Recruiter',
        senderAvatar: 'https://ui-avatars.com/api/?name=Recruiter&background=8B5CF6&color=fff&size=64',
        receiverId: userId,
        receiverName: userName || 'Applicant',
        content: "Thank you for your message! We'll review your application and get back to you shortly.",
        timestamp: new Date().toISOString(),
        isRead: true
      };
      ...
      toast.success(`Reply from Recruiter`);
    }, 2000);
  };
            ...
            <div className="flex-1 overflow-y-auto">
              {filteredConversations.length > 0 ? (
                  ...
                  >
                    <div className="relative flex-shrink-0">
                      <Image
                        width={48}
                        height={48}
                        src={conv.companyLogo || `https://ui-avatars.com/api/?name=${encodeURIComponent(conv.companyName || 'Company')}&background=8B5CF6&color=fff&size=64`}
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-xs text-gray-500">Apply to jobs to start messaging</p>
                </div>
              )}
            </div>
          </div>
            ...
            {selectedConversation ? (
                ...
                <div className="flex items-center justify-between p-4 border-b border-white/10 bg-white/5">
                  <div className="flex items-center gap-3">
                    <Image
                      width={40}
                      height={40}
                      src={selectedConversation.companyLogo || `https://ui-avatars.com/api/?name=${encodeURIComponent(selectedConversation.companyName || 'Company')}&background=8B5CF6&color=fff&size=64`}
                          ...
                          <div className={`flex items-start gap-2 max-w-[75%] ${isOwn ? 'flex-row-reverse' : ''}`}>
                            {!isOwn && (
                              <Image
                                width={32}
                                height={32}
                                src={msg.senderAvatar || `https://ui-avatars.com/api/?name=Recruiter&background=8B5CF6&color=fff&size=64`}
                                alt={msg.senderName}
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-400">Choose a company to start messaging</p>
                </div>
              </div>
            )}
          </div>
