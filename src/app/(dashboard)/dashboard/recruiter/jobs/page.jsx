                        ...
                        <tbody>
                            {paginatedJobs.length === 0 ? (
                                ...
                                paginatedJobs.map((job) => {
                                    ...
                                    return (
                                        <tr key={job.id} className="border-b border-white/5 hover:bg-white/5 transition-all duration-300 group">
                                            ...
                                            <td className="px-5 py-4">
                                                <div className="flex items-center justify-center gap-1">
                                                    {/* <Link href={`/dashboard/recruiter/jobs/${job.id}`}>
                                                        <button className="p-1.5 rounded-lg text-gray-400 hover:text-blue-400 hover:bg-white/10 transition-all duration-200 group-hover:scale-105" title="View Job Details">
                                                            <Eye size={16} />
                                                        </button>
                                                    </Link> */}
                                                    <Link href={`/dashboard/recruiter/jobs/${job.id}/applicants`}>
                                                    ...
                                                    <button onClick={() => handleDeleteJob(job.id)} className="p-1.5 rounded-lg text-gray-400 hover:text-red-400 hover:bg-white/10 transition-all duration-200 group-hover:scale-105" title="Delete">
                                                        <Trash2 size={16} />
                                                    </button>
                                                </div>
                                            </td>
