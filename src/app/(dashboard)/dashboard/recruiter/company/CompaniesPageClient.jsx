    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {/* ✅ FIXED: Industry dropdown — value + onChange instead of selectedKeys + onSelectionChange */}
                ...
                {/* ✅ FIXED: Employee count dropdown — value + onChange instead of selectedKeys + onSelectionChange */}
                <Field label="Employee Count Range">
                    <Select
                        value={formData.employeeCount || null}
            ...
            <div className="flex justify-end gap-3 pt-4">
                ...
                <Button onPress={handleSubmit} isLoading={submitting}
                    className="cursor-pointer bg-linear-to-r from-fuchsia-500 to-violet-600 text-white shadow-lg shadow-violet-500/20">
